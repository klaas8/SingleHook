...
function f($info,$parameter) {
    ...
    if(is_array($json["text"])) {
        ...
        $info["url"] = ((!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off' || $_SERVER['SERVER_PORT'] == 443) ? "https://" : "http://").$_SERVER['HTTP_HOST'].$_SERVER['SCRIPT_NAME']."?url=https://www.lanzoui.com/".$json['text'][0]["id"]."&type=down";
